import { assert } from "src/common/utils/utils";
import { circleFragmentShaderSource, shockwaveFragmentShaderSource, zigzagFragmentShaderSource } from "src/common/components/animation/shaders";
import { Props, Type, UniformTypes } from "src/common/components/animation/types";
